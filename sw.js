...
const CACHE_NAME = 'chorister-corner-v1.0.6'; // Update this for every release
const DATA_CACHE_NAME = 'chorister-corner-data-v1.0.6'; // Separate cache for dynamic data

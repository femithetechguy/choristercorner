...
const CACHE_NAME = 'chorister-corner-v1.1.2'; // Update this for every release
const DATA_CACHE_NAME = 'chorister-corner-data-v1.1.2'; // Separate cache for dynamic data

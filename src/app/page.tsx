    ...
    <div className="min-h-screen">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-16">
        <div className="flex items-center gap-2 mb-8">
          ...
          <h2 className="text-2xl font-bold">{config.home.featuredSongs.heading}</h2>
        </div>
        ...
        <div className="text-center mt-8">
          ...
          >
            {config.home.featuredSongs.buttonText}
          </Link>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-16">
        <div className="flex items-center gap-2 mb-8">
          ...
          <h2 className="text-2xl font-bold">{config.home.featuredHymns.heading}</h2>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="text-center mt-8">
          <Link
            ...
            className="inline-block bg-purple-600 text-white px-8 py-3 rounded-lg hover:bg-purple-700 transition"
          >
            {config.home.featuredHymns.buttonText}
          </Link>
        </div>
      </section>
